...
function buildEnglishSentenceQuestion(word) {
  ...
  return `Which Japanese description best matches the following security/IT term?
"${english}"`;
}
...
function buildJapaneseExplanation(word) {
  ...
  return `${japanese}に関する説明。`;
}

function buildQuestionText(word) {
  return buildEnglishSentenceQuestion(word);
}
...
function normalizeWord(word) {
  ...
  return {
    ...
    englishQuestion: String(word.englishQuestion || buildEnglishSentenceQuestion(word)).trim(),
    japaneseExplanation: String(word.japaneseExplanation || buildJapaneseExplanation(word)).trim(),
...
function getSelectedQuestionMode() {
  ...
  return selected === "sentence" ? "sentence" : "term";
}

function getQuestionText(word, mode) {
  return mode === "sentence" ? word.englishQuestion : word.english;
}

function getCorrectAnswerText(word, mode) {
  return mode === "sentence" ? word.japaneseExplanation : word.japanese;
}
...
function renderChoiceQuestion() {
  ...
  if (!candidates.length) {
    ...
    $("choiceQuestion").classList.remove("sentence-mode");
  ...
  $("choiceQuestion").classList.toggle("sentence-mode", currentQuestionMode === "sentence");
